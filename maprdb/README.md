...
# MapR-DB (OJAI) Driver for YCSB
This driver is a binding for the YCSB facilities to operate against a MapR-DB Server cluster.

## Quickstart

### 1. Start a MapR-DB Server
You need to start a single node or a cluster to point the client at. Please see [MapR DB Documentation](http://doc.mapr.com/display/MapR/MapR-DB) for more details and instructions.
...
### 3. Create a MapR-DB JSON table for testing

NOTE: Everything here onwards is a place holder!
