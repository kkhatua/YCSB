 ...
 */
public class SkewedLatestLongGenerator extends NumberGenerator
{
	private LongCounterGenerator _basis;
	private final ZipfianGenerator _zipfian;

	public SkewedLatestLongGenerator(LongCounterGenerator basis)
	{
		_basis=basis;
  ...
  public Long nextValue()
	...
	{
		SkewedLatestLongGenerator gen=new SkewedLatestLongGenerator(new LongCounterGenerator(1000));
